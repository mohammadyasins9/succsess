...
<body>
	<div id="wrapper">
			...
			<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav side-nav">
						...
						<li class="active"><a href="data_wartawan.php"><i class="fa fa-user"></i> Data Wartawan</a></li>
						<li><a href="tampilgajiaja.php"><i class="fa fa-bar-chart-o"></i> Data Gaji Wartawan</a></li>
						<li><a href="#"><i class="fa fa-table"></i> Data Lembur Wartawan</a></li>
						<li><a href="#"><i class="fa fa-edit"></i> Data Presensi Wartawan</a></li>
						<li><a href="tampilgaji.php"><i class="fa fa-desktop"></i> Cetak Slip Gaji Wartawan</a></li>
						<li class="dropdown">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1> Data <small>Wartawan </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-user"></i> Halaman Data Wartawan </li>
            </ol>
            <table width="900">
            <tr>
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Data Wartawan</h3> 
              </div>
              <div class="panel-body">
                 <div class="table-responsive">
					...
					<table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        <th>Kode_wartawan <i class="fa fa-sort"></i></th>
                ...
                <div class="text-right">
                  <a href="tambah.php" class="btn btn-sm btn-warning">Tambah Data Wartawan <i class="fa fa-arrow-circle-right"></i></a>
