...
<body>
	<div id="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Pengguna <small>Admin </small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-dashboard"></i> Halaman Pengguna  </li>
            </ol>
            <table width="900">
            <tr>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Data Pengguna Admin </h3> 
              </div>
              <div class="panel-body">
                 <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
					...
					$tampil=mysql_query("select * from tb_user order by user_id desc limit $posisi, $batas");
					$no = 1+$posisi;
                    ...
                    <td><a class="btn btn-sm btn-primary" href="edit.php?hal=edit&kd=<?php echo $data['user_id'];?>"><i class="fa fa-edit"></i> Edit</a>
                        <a class="btn btn-sm btn-danger" href="hapus_pengguna.php?hal=hapus&user_id=<?php echo $data['user_id'];?>" onClick="return confirm('Apakah anda yakin?');"><i class="fa fa-wrench"></i> Hapus</a></td></tr>
			  ...
			  <tr>
					<td colspan="7">
				<?php
				$jml_data = mysql_num_rows(mysql_query("SELECT * FROM tb_user"));
                ...
                <div class="text-right">
                  <a href="tambah_pengguna.php" class="btn btn-sm btn-warning">Tambah Data Pengguna <i class="fa fa-arrow-circle-right"></i></a>
