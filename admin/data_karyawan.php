              ...
              <div class="panel-body">
                 <div class="table-responsive">
					...
					<table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        <th width="15%">Kode_karyawan <i class="fa fa-sort"></i>
						</th>
                        <th>Nama <i class="fa fa-sort"></i>
						</th>
						<th>Alamat <i class="fa fa-sort"></i></th>
						<th>No.rekening <i class="fa fa-sort"></i></th>
                        <th width="15%">Status <i class="fa fa-sort"></i></th>
                        <th width="15%">Jabatan <i class="fa fa-sort"></i></th>
