      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="tampilgaji.php"><i class="fa fa-desktop"></i> Cetak Slip Gaji Karyawan</a></li>
            <li class="dropdown">
...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Cetak Data<small>Gaji Karyawan</small></h1>
            <table width="900">
            <tr>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Cetak Data Gaji Karyawan </h3> 
              </div>
                 ...
                 <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th width="12%">Uang Pinjaman <i class="fa fa-sort"></i></th>
                    ...
                    <td>Rp. 10000</td>
                    <td>11/10/2015</td>
                    <td><a class="btn btn-sm btn-danger" href="?hal=printgaji&kd=<?php echo $data['kode_kar'];?>"><i class="fa fa-print"></i> Print</a>
                    </tr>
             <?php } ?>
                   </tbody>
                   </table>
