...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sistem Informasi Wawasan">
    <meta name="author" content="Mohammad Yasin S">

    <title>Welcome to Sistem Informasi Wawasan</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Sistem Informasi Wawasan</a>
        </div>
